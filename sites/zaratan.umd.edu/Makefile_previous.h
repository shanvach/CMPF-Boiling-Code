...
HDF5_PATH    = $(HDF5_ROOT)
#HDF5_PATH     = /home/svachhan/scratch/hdf5-1.14.3_build
#HDF5_PATH    =  /software/modulefiles/modules/production/rhel8/hdf5/intel/2021.4.0/intel-mpi/2021.6.0/zen2/1.10.7	
HYPRE_PATH   = $(HYPRE_ROOT)
#HYPRE_PATH   = 
MPI_PATH     = $(OPENMPI_ROOT)
#MPI_PATH     = /software/modulefiles/modules/production/rhel8/intel-mpi/intel/2021.4.0/zen2/2021.6.0
ZLIB_PATH    =
PAPI_PATH    =
NCMPI_PATH   =
...
F90COMP = $(MPI_PATH)/bin/mpif90
LINK    = $(MPI_PATH)/bin/mpicxx -std=c++14
...
#CFLAGS_HDF5  = -I$HDF5_INCDIR -DH5_USE_18_API
...
LIB_HDF5   = -L$(HDF5_PATH)/lib -lm -lgfortran -lmpi
