...
ZLIB_PATH  =
#LIB_STDCXX = -L/opt/gcc/9.3.0/snos/lib64 -lstdc++
LIB_STDCXX = -lstdc++

PAPI_PATH  =
PAPI_FLAGS =

NCMPI_PATH = ${CRAY_PARALLEL_NETCDF_DIR}
MPE_PATH   =
...
FCOMP   = ${MPI_PATH}/bin/ftn
CCOMP   = ${MPI_PATH}/bin/cc
CPPCOMP = ${MPI_PATH}/bin/CC
LINK    = ${MPI_PATH}/bin/ftn
