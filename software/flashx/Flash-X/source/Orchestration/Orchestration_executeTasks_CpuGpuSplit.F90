...
!!
!! @details
!! Use the runtime to execute the given task functions using the CPU/GPU Split thread
!! team configuration.  Upon termination, one of the task functions will have been
!! applied by ther appropriate team to each leaf blocks using the given number of threads.
