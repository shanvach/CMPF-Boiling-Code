!!****if* source/Simulation/SimulationMain/CCSN_Chimera/gr_mpolePot2Dcylindrical
!! NOTICE
...
!
     ...
     zpm = bndBoxJLow - gr_mpolePtZpos                            ! z-axis location of point mass
     ...
     do jF = 0, jFmax                                             ! loop over local j face indices
      ...
      xpm = bndBoxILow + iB *DeltaIHalf - gr_mpolePtXpos          ! Rcyl-axis location of point mass
      ...
      do iF = iB, iFmax, 2                                        ! loop over local i face indices
       ...
       rpm = sqrt(zpm * zpm + xpm * xpm)                          ! radial position of point mass
!
!
!        ...Find the radial bin.
!
