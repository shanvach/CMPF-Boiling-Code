!!****f* source/Simulation/SimulationMain/incompFlow/BubblyFlow/Simulation_finalize
!! NOTICE
...
subroutine Simulation_finalize()
   use Simulation_data, only: sim_xBubble, sim_yBubble, sim_zBubble
   implicit none
   deallocate(sim_xBubble, sim_yBubble, sim_zBubble)
